        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pt-20 pb-20 md:pt-32 md:pb-28 text-center">
          ...
          <Reveal delay={0.35}>
            <div className="mt-9 flex flex-wrap justify-center gap-3">
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 rounded-full bg-brand px-7 py-3.5 text-sm font-semibold text-white shadow-brand transition-all duration-300 hover:-translate-y-0.5 hover:opacity-90"
              >
              ...
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-full border border-[#25D366] bg-[#25D366]/10 px-7 py-3.5 text-sm font-semibold text-[#128C7E] transition-all duration-300 hover:bg-[#25D366] hover:text-white hover:-translate-y-0.5"
              >
